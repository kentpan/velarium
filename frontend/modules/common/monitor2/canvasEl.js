...
(function () {
    ...
    Canvas.Element.prototype._cornerImg = null;
    /**
    ...
    Canvas.Element.prototype._loadCanvasIcons = function () {
        if (!!this._oConfig.corners) {
            this._cornerImg = this._oConfig.corners;
        }
    };
    Canvas.Element.prototype.setCanvasIcons = function (context, oIcon) {
    ...
    Canvas.Element.prototype.checkCollision = function (oPoint, oCircle) {
        var flag = false;
