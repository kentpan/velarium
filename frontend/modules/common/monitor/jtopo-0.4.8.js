!function(window) {
    ...
    JTopo = {
        ...
        MouseCursor: {
            ...
            move: "move",
            open_hand: "url(./image/cur/openhand.cur) 8 8, default",
...
function(a) {
    ...
    function c(c) {
     ...
     //   console.log(this, (this.width = this.width/2), (this.height = this.height/2));
        var o = !0
          , p = null ;
        ...
        this.setCenter = function(a, b) {
            ...
            this.childs.forEach(function(d) {
                var e = a - c.canvas.width / 2 / 2
                  , f = b - c.canvas.height / 2 / 2;
                d.translateX = -e,
                d.translateY = -f
            })
        }
...
function(a) {
    ...
    function c() {
        ...
        this.isInBound = function(a, b) {
            return a > this.x && a < this.x + this.width/2 * Math.abs(this.scaleX) && b > this.y && b < this.y + this.height/2 * Math.abs(this.scaleY)
        }
        ,
...
function(a) {
    function b(c) {
        ...
        this.paint = function(a) {
            ...
            this.paintTriangle(a)
        }
        ,
        this.paintTriangle = function(a) {
            var b = "0,0,0"
              , c = 0.5;
            if (this.inTriangle) {
                a.beginPath(),
            ...
            if (null  != b && "" != b) {
                ...
                if (null  != k && k.length) {
                    ...
                    k.forEach(function(item, index) {
                        var c = a.measureText(item).width;
                        if (c > m) {
                            m = c;
                        }
                    });
                    var d = a.measureText("田").width;
                    a.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")";
                    var e = this.getTextPostion(this.textPosition, m, d, l);
                    for (var i = 0; i < k.length; i++) {
                        a.fillText(k[i], e.x, e.y + (d * i));
                    }
                }
                a.closePath()
            }
        ...
        ,
        this.getTextPostion = function(a, b, c, l) {
            var d = null ;
